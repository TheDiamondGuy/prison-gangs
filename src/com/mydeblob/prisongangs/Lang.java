...
public enum Lang {
	...
	SUCCESFULLY_CREATED_GANG("created-gang", "&aSuccessfully created a gang with the name of %g%!"), 
	...
	SUCCESS_UNINVITE("success-uninvite", "&c%s% has just uninvited %t%!"),
	...
	SENDER_SUCCESS_PROMOTE("sender-success-promote", "&aYou succesfully promoted %p% to a %r%!"), 
	...
	TARGET_SUCCESS_KICK("target-success-kick", "&cYou have been kicked from the gang %g% by %p%"), 
