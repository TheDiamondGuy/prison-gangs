...
//	}
	...
	public ArrayList<String> getGangPlayerStats(Gang g){
		...
		for(String s : g.getMembers()){
			...
			String name = "Member " + this.p.getConfig().getString("seperator") + " " +  s + " - " + status;
			memberData.add(name);
		}
		for(String s : g.getTrusted()){
			...
			String name = "Trusted " + this.p.getConfig().getString("seperator") + " " +  s + " - " + status;
			memberData.add(name);
		}
		for(String s : g.getOfficers()){
			...
			String name = "Officer " + this.p.getConfig().getString("seperator") + " " +  s + " - " + status;
			memberData.add(name);
		}
		for(String s : g.getLeaders()){
			...
			String name = "Leader " + this.p.getConfig().getString("seperator") + " " +  s + " - " + status;
			memberData.add(name);
		}
		...
		String name = "Owner " + this.p.getConfig().getString("seperator") + " " + owner  + " - " + status;
		memberData.add(name);
		return memberData;
	}
